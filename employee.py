...
class Employee:
    def __init__(self,root):
        ...
        # MArried
        lbl_married_status=Label(upper_frame,text='Married Status',font=('arial',12,'bold'),fg='black',bg='white')
        ...
        # CTC
        lbl_ctc=Label(upper_frame,text='Salary(CTC)',font=('arial',12,'bold'),fg='black',bg='white')
        ...
        #=================Lower_frame====================
        lower_frame=LabelFrame(Main_frame,bd=2,relief=RIDGE,bg='magenta',text='Employee Information table',font=('times new roman',12,'bold'),fg='red')
        ...
        search_by=Label(search_frame,font=('arial',12,'bold'),text='Search BY:',fg='red',bg='lightgreen')
        ...
        msg_text=Label(search_frame,font=('time new roman',30,'bold'),text="FoCus On Your GoALs",fg='red',bg='white')
        ...
        # ================Employee Table==================
        # Table Frame
        table_frame=Frame(lower_frame,bd=2,relief=RIDGE,bg='pink')
    ...
    def add_data(self):
        if self.var_dep.get()=="" or self.var_email.get()=="":
            ...
            try:
                conn=mysql.connector.connect(host='localhost',username='root',password='',database='python')
        ...
        if self.var_dep.get()=="" or self.var_email.get()=="":
            ...
            try:
                ...
                if update>0:
                    conn=mysql.connector.connect(host='localhost',username='root',password='',database='python')
                    my_cursor=conn.cursor()
                    my_cursor.execute('Update Employee set Department=%s,Name=%s,Designation=%s,Email=%s,Address=%s,Marital_status=%s,DOB=%s,DOJ=%s,id_proof_type=%s,id_proof=%s,Gender=%s,Phone=%s,Country=%s,Salary=%s',(
                                                                                    self.var_dep.get(),
                                                                                    self.var_name.get(),
                                                                                    self.var_desig.get(),
                                                                                    self.var_email.get(),
